	...
	return <div className="container">
		<div className="row">
			<div className="col-xs-12">
				...
				<p>Krypton8 is revolutionary part of the cryptocurrency ecosystem. It is how digital asset exchange <i>should</i> work. The platform gives you the power to quickly swap between assets – no account required.</p>
